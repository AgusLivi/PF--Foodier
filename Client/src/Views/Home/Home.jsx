  ...
  return (
    ...
    <button onClick={toggleModal} className={Style.categoria}>Categorias</button>
        ...
        <div className={Style.filtro}>
          ...
          <select name="orderBy" value={formData.orderBy} onChange={(e) => setOrderByy(e.target.value)}>
        ...
        <div>
          <label>Orden:</label>
          <select name="order" value={formData.order} onChange={(e) => setOrderr(e.target.value)}>
